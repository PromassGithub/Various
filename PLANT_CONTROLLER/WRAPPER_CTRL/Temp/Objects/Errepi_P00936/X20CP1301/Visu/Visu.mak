...
PANEL_HW_SOURCE_Visu=C:/projects/GitH/Various/PLANT_CONTROLLER/WRAPPER_CTRL/Physical/Errepi_P00936/Hardware.hw 
DIS_OBJECTS_Visu=$(PANEL_HW_OBJECT_Visu) $(KEYMAP_OBJECTS_Visu)

# KeyMapping flags
$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Errepi_P00936/X20CP1301/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco)' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'O4.34' -L '' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/Errepi_P00936/X20CP1301/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.72.7/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'WRAPPER_CTRL' -sfas -vcob '$(VCOBJECT_Visu)'
...
KEYMAP_SOURCES_Visu=$(AS_PROJECT_PATH)/Physical/Errepi_P00936/X20CP1301/VC/PS2-Keyboard.dis 
...
vcPostBuild_Visu :
	$(VCC) -pb -vcm '$(TEMP_PATH_Visu)/MODULEFILES.vcm' -fw '$(VCFIRMWAREPATH)' $(VCCFLAGS_Visu) -p Visu -vcr 4727 -sfas
