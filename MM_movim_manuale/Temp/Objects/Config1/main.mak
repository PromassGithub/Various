...
export WIN32_AS_PROJECT_PATH := "C:\projects\MM_movim_manuale"
...
export WIN32_AS_TEMP_PATH := "C:\projects\MM_movim_manuale\Temp"
export WIN32_AS_BINARIES_PATH := "C:\projects\MM_movim_manuale\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/MM_movim_manuale.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
