define([
    ...
    function _redrawWidget(self) {
        ...
        if (self.widget.settings.childPositioning === Enum.ChildPositioning.relative && self.widget.container.children('#' + self.widget.elem.id + '_scrollWrapper').hasClass('scrollWrapper')) {
