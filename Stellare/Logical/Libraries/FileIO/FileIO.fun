...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK FileCreate				(*creates a file; asynchronous execution*)
	VAR_INPUT
		...
		pDevice		: UDINT;			(*REPORT_DEVICE name given as a pointer*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK FileCopy					(*copies a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pSrcDev		: UDINT;			(*pointer to the source file REPORT_DEVICE name*)
		pSrc		: UDINT;			(*pointer to the existing file name*)
		pDestDev	: UDINT;			(*pointer to the destination file REPORT_DEVICE name*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK DevMemInfo				(*determines a file REPORT_DEVICE's memory information; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*REPORT_DEVICE name given as a pointer*)
	END_VAR
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK DevLink					(*creates the file REPORT_DEVICE; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*new REPORT_DEVICE name given as a pointer*)
	...
	VAR_OUTPUT
		status		: UINT;				(*execution status: ERR_OK, ERR_FUB_ENABLE_FALSE, ERR_FUB_BUSY, 0xXXXX = see help*)
		handle		: UDINT;			(*file REPORT_DEVICE handle*)
	END_VAR
END_FUNCTION_BLOCK

{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK DevUnlink				(*unlinks the REPORT_DEVICE; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		handle		: UDINT;			(*file REPORT_DEVICE handle*)
	END_VAR
