...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK TimeDeviceGetInfo		(*read information about time REPORT_DEVICE*)
	VAR_INPUT
		enable			:BOOL;			(*enables execution*)
	...
	VAR_OUTPUT
		...
		avgDeviation	:REAL;			(*average deviation between software time and time REPORT_DEVICE*)	
		status			:UINT;			(*execution status: ERR_OK, ERR_FUB_ENABLE_FALSE, ERR_FUB_BUSY, 0xXXXX = see help*)	
	END_VAR		
	VAR
        i_state			:UINT;			(*internal variable*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK DstGetInfo				(*read information about time REPORT_DEVICE*)
	VAR_INPUT
		enable			:BOOL;			(*enables execution*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK DstGetInfoDT				(*read information about time REPORT_DEVICE*)
	VAR_INPUT
		enable			:BOOL;			(*enables execution*)
