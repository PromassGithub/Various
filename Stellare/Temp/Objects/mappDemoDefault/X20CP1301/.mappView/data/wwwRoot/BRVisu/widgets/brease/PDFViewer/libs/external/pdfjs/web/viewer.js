...
function getPDFFileNameFromURL(url) {
  ...
  if (isDataSchema(url)) {
    if (true /*window.debugFlag*/) {console.warn('getPDFFileNameFromURL: ' + 'ignoring "data:" URL for performance reasons.');}
...
var PDFViewerApplication = {
  ...
  viewerPrefs: {
    sidebarViewOnLoad: 0,  // _pdf_sidebar.SidebarView.NONE,
    pdfBugEnabled: false,
  ...
  load: function load(pdfDocument, scale) {
    ...
    pdfDocument.getPageLabels().then(function (labels) {
      ...
      if (numLabels !== _this6.pagesCount) {
        if (true /*window.debugFlag*/) {console.error('The number of Page Labels does not match ' + 'the number of pages in the document.');}
        return;
      }
    ...
    pagesPromise.then(function () {
      ...
      pdfDocument.getJavaScript().then(function (javaScript) {
        if (javaScript.length) {
          if (true /*window.debugFlag*/) {console.warn('Warning: JavaScript is not supported');}
    ...
    pdfDocument.getMetadata().then(function (_ref5) {
      ...
      if (false /*window.debugFlag*/) {console.log('PDF ' + pdfDocument.fingerprint + ' [' + info.PDFFormatVersion + ' ' + (info.Producer || '-').trim() + ' / ' + (info.Creator || '-').trim() + ']' + ' (PDF.js: ' + (_pdfjsLib.version || '-') + (!_pdfjsLib.PDFJS.disableWebGL ? ' [WebGL]' : '') + ')');}
      var pdfTitle = void 0;
      ...
      if (info.IsAcroFormPresent) {
        if (true /*window.debugFlag*/) {console.warn('Warning: AcroForm/XFA is not supported');}
...
function webViewerInitialized() {
  ...
  /* DG 8-15-2018: Work-around to enable fullscreen/presentation mode on the T50
...
function webViewerPageMode(evt) {
  ...
  switch (mode) {
    ...
    case 'none':
      ...
      break;
    default:
    if (true /*window.debugFlag*/) {console.error('Invalid "pagemode" hash parameter: ' + mode);}
      return;
  }
    ...
    value: function navigateTo(dest) {
        ...
        if (destRef instanceof Object) {
          ...
          if (pageNumber === null) {
            _this.pdfDocument.getPageIndex(destRef).then(function (pageIndex) {
              ...
              if (true /*window.debugFlag*/) {console.error('PDFLinkService.navigateTo: "' + destRef + '" is not ' + ('a valid page reference, for dest="' + dest + '".'));}
            });
            return;
          }
          ...
          if (true /*window.debugFlag*/) {console.error('PDFLinkService.navigateTo: "' + destRef + '" is not ' + ('a valid destination reference, for dest="' + dest + '".'));}
          return;
        }
        if (!pageNumber || pageNumber < 1 || pageNumber > _this.pagesCount) {
          if (true /*window.debugFlag*/) {console.error('PDFLinkService.navigateTo: "' + pageNumber + '" is not ' + ('a valid page number, for dest="' + dest + '".'));}
          return;
        }
      ...
      new Promise(function (resolve, reject) {
        ...
        if (!(data.explicitDest instanceof Array)) {
          if (true /*window.debugFlag*/) {console.error('PDFLinkService.navigateTo: "' + data.explicitDest + '" is' + (' not a valid destination array, for dest="' + dest + '".'));}
          return;
        }
    ...
    value: function setHash(hash) {
      ...
      if (hash.indexOf('=') >= 0) {
          ...
          if (zoomArg.indexOf('Fit') === -1) {
            ...
            if (zoomArg === 'Fit' || zoomArg === 'FitB') {
              ...
              if (zoomArgs.length !== 5) {
                if (true /*window.debugFlag*/) {console.error('PDFLinkService.setHash: Not enough parameters for "FitR".');}
              } else {
                dest = [null, { name: zoomArg }, zoomArgs[1] | 0, zoomArgs[2] | 0, zoomArgs[3] | 0, zoomArgs[4] | 0];
              }
            } else {
              if (true /*window.debugFlag*/) {console.error('PDFLinkService.setHash: "' + zoomArg + '" is not ' + 'a valid zoom value.');}
            }
          }
        }
        if (dest) {
        ...
        if (/^\d+$/.test(hash) && hash <= this.pagesCount) {
          if (true /*window.debugFlag*/) {console.warn('PDFLinkService_setHash: specifying a page number ' + 'directly after the hash symbol (#) is deprecated, ' + ('please use the "#page=' + hash + '" form instead.'));}
          this.page = hash | 0;
        }
        dest = unescape(hash);
        try {
        ...
        if (true /*window.debugFlag*/) {console.error('PDFLinkService.setHash: "' + unescape(hash) + '" is not ' + 'a valid destination.');}
      }
    }
  }, {
  ...
  function PDFCursorTools(_ref) {
    ...
    Promise.all([preferences.get('cursorToolOnLoad'), preferences.get('enableHandToolOnLoad')]).then(function (_ref2) {
      ...
      if (handToolPref === true) {
        preferences.set('enableHandToolOnLoad', true); /* false */
  ...
  _createClass(PDFCursorTools, [{
    ...
    value: function switchTool(tool) {
      ...
      switch (tool) {
        ...
        case CursorTool.ZOOM:
        default:
        if (true /*window.debugFlag*/) {console.error('switchTool: "' + tool + '" is an unsupported value.');}
          return;
      }
      this.active = tool;
      this._dispatchEvent();
  ...
  _createClass(PDFFindController, [{
      ...
      var _loop = function _loop(i, ii) {
        ...
        promise = promise.then(function () {
          return _this2.pdfViewer.getPageTextContent(i).then(function (textContent) {
            ...
            if (true /*window.debugFlag*/) {console.error('Unable to get page ' + (i + 1) + ' text content', reason);}
    ...
    value: function nextPageMatch() {
      if (this.resumePageIdx !== null) {
        if (true /*window.debugFlag*/) {console.error('There can only be one pending page.');}
      }
      var matches = null;
      do {
...
PDFPrintService.prototype = {
  layout: function layout() {
    ...
    if (!hasEqualPageSizes) {
      if (true /*window.debugFlag*/) {console.warn('Not all pages have the same size. The printed ' + 'result may be incorrect!');}
    }
...
window.print = function print() {
  if (activeService) {
    if (true /*window.debugFlag*/) {console.warn('Ignored window.print() because of a pending print job.');}
    return;
  }
  ensureOverlay().then(function () {
    if (activeService) {
  ...
  try {
    ...
    if (!activeService) {
      if (true /*window.debugFlag*/) {console.error('Expected print service to be initialized.');}
      ensureOverlay().then(function () {
        if (overlayManager.active === 'printServiceOverlay') {
          overlayManager.close('printServiceOverlay');
        }
...
document.webL10n = function (window, document, undefined) {
  ...
  function getL10nAttributes(element) {
    ...
    if (l10nArgs) {
      try {
        ...
        if (true /*window.debugFlag*/) {console.warn('could not parse arguments for #' + l10nId);}
      }
    }
    return {
      id: l10nId,
    ...
    function parseProperties(text, parsedPropertiesCallback) {
      ...
      function loadImport(url, callback) {
        xhrLoadText(url, function (content) {
          ...
          if (true /*window.debugFlag*/) {console.warn(url + ' not found.');}
          callback();
        });
      }
  ...
  function loadLocale(lang, callback) {
    ...
    if (langCount === 0) {
      ...
      if (dict && dict.locales && dict.default_locale) {
        if (true /*window.debugFlag*/) {console.log('using the embedded JSON directory, early way out');}
        ...
        if (true /*window.debugFlag*/) {console.log('no resource to load, early way out');}
      }
  ...
  function getPluralRules(lang) {
    ...
    if (!(index in pluralRules)) {
      if (true /*window.debugFlag*/) {console.warn('plural form unknown for [' + lang + ']');}
      return function () {
        return 'other';
      };
    }
  ...
  function getL10nData(key, args, fallback) {
    ...
    if (!data) {
      if (true /*window.debugFlag*/) {console.warn('#' + key + ' is undefined.');}
      if (!fallback) {
        return null;
      }
      data = fallback;
  ...
  function substArguments(str, args, key) {
    ...
    return str.replace(reArgs, function (matched_text, arg) {
      ...
      if (true /*window.debugFlag*/) {console.log('argument {{' + arg + '}} for #' + key + ' is undefined.');}
      return matched_text;
    });
  }
  function translateElement(element) {
    ...
    if (!data) {
      if (true /*window.debugFlag*/) {console.warn('#' + l10n.id + ' is undefined.');}
      return;
    }
    if (data[gTextProp]) {
  ...
  _createClass(PDFPageView, [{
      ...
      if (this.textLayer) {
        ...
        switch (textAbsRotation) {
          ...
          case 270:
            ...
            break;
          default:
          if (true /*window.debugFlag*/) {console.error('Bad rotation value.');}
            break;
        }
    ...
    value: function draw() {
      ...
      if (this.renderingState !== _pdf_rendering_queue.RenderingStates.INITIAL) {
        if (true /*window.debugFlag*/) {console.error('Must be in new state before drawing');}
        this.reset();
      }
      if (!this.pdfPage) {
    ...
    value: function switchView(view) {
      ...
      switch (view) {
        ...
        case SidebarView.ATTACHMENTS:
          ...
          break;
        default:
        if (true /*window.debugFlag*/) {console.error('PDFSidebar_switchView: "' + view + '" is an unsupported value.');}
          return;
      }
      this.active = view | 0;
  ...
  _createClass(PDFThumbnailViewer, [{
    ...
    value: function setDocument(pdfDocument) {
      ...
      pdfDocument.getPage(1).then(function (firstPage) {
        ...
        if (true /*window.debugFlag*/) {console.error('Unable to initialize thumbnail viewer', reason);}
      });
    }
  }, {
    ...
    value: function setPageLabels(labels) {
      ...
      if (!labels) {
        ...
        this._pageLabels = null;
        if (true /*window.debugFlag*/) {console.error('PDFThumbnailViewer_setPageLabels: Invalid page labels.');}
      } else {
    ...
    value: function _ensurePdfPageLoaded(thumbView) {
      ...
      var promise = this.pdfDocument.getPage(pageNumber).then(function (pdfPage) {
        ...
        if (true /*window.debugFlag*/) {console.error('Unable to get page for thumb view', reason);}
        _this2._pagesRequests[pageNumber] = null;
      });
  ...
  _createClass(PDFViewer, [{
    ...
    value: function _setCurrentPageNumber(val) {
      ...
      if (!(0 < val && val <= this.pagesCount)) {
        if (true /*window.debugFlag*/) {console.error('PDFViewer._setCurrentPageNumber: "' + val + '" is out of bounds.');}
        return;
      }
      var arg = {
        source: this,
    ...
    value: function setDocument(pdfDocument) {
      ...
      firstPagePromise.then(function (pdfPage) {
        ...
        onePageRenderedCapability.promise.then(function () {
          ...
          var _loop = function _loop(_pageNum) {
            pdfDocument.getPage(_pageNum).then(function (pdfPage) {
              ...
              if (true /*window.debugFlag*/) {console.error('Unable to get page ' + _pageNum + ' to initialize viewer', reason);}
              if (--getPagesLeft === 0) {
                pagesCapability.resolve();
              }
            });
        ...
        if (true /*window.debugFlag*/) {console.error('Unable to initialize viewer', reason);}
      });
    }
  }, {
    key: 'setPageLabels',
    value: function setPageLabels(labels) {
      ...
      if (!labels) {
        ...
        this._pageLabels = null;
        if (true /*window.debugFlag*/) {console.error('PDFViewer.setPageLabels: Invalid page labels.');}
      } else {
        this._pageLabels = labels;
      }
      ...
      if (scale > 0) {
        ...
        switch (value) {
          ...
          case 'auto':
            ...
            break;
          default:
          if (true /*window.debugFlag*/) {console.error('PDFViewer._setScale: "' + value + '" is an unknown zoom value.');}
            return;
        }
    ...
    value: function scrollPageIntoView(params) {
      ...
      if (arguments.length > 1 || typeof params === 'number') {
        if (true /*window.debugFlag*/) {console.warn('Call of scrollPageIntoView() with obsolete signature.');}
        var paramObj = {};
      ...
      if (!pageView) {
        if (true /*window.debugFlag*/) {console.error('PDFViewer.scrollPageIntoView: Invalid "pageNumber" parameter.');}
        return;
      }
      var x = 0,
          y = 0;
      ...
      switch (dest[1].name) {
        ...
        case 'FitR':
          ...
          break;
        default:
        if (true /*window.debugFlag*/) {console.error('PDFViewer.scrollPageIntoView: "' + dest[1].name + '" ' + 'is not a valid destination type.');}
          return;
      }
    ...
    value: function _ensurePdfPageLoaded(pageView) {
      ...
      var promise = this.pdfDocument.getPage(pageNumber).then(function (pdfPage) {
        ...
        if (true /*window.debugFlag*/) {console.error('Unable to get page for page view', reason);}
        _this2._pagesRequests[pageNumber] = null;
      });
      this._pagesRequests[pageNumber] = promise;
      return promise;
    ...
    value: function convertMatches(matches, matchesLength) {
      ...
      for (var m = 0, len = matches.length; m < len; m++) {
        ...
        if (i === textContentItemsStr.length) {
          if (true /*window.debugFlag*/) {console.error('Could not find a matching mapping');}
        }
        var match = {
          begin: {
            divIdx: i,
