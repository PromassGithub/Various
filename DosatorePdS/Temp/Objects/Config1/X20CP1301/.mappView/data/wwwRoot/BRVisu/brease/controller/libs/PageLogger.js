define(['brease/enum/Enum', 'brease/config', 'brease/controller/libs/LogCode'], function (Enum, config, LogCode) {
        ...
        switch (logId) {
            case LogCode.PAGE_NOT_FOUND:
                ...
                if (data.isStartPage === true) {
                    promise = _showClientMessage.call(this, logId, [data.pageId || 'undefined']);
                }
                break;
            ...
            case LogCode.NO_PAGES_FOUND:
                ...
                promise = _showClientMessage.call(this, logId, [data.visuId]);
            ...
            case LogCode.NO_LAYOUTS_FOUND:
                ...
                promise = _showClientMessage.call(this, logId, [data.visuId], data.container);
                _log(logId, [data.visuId]);
                break;
            ...
            case LogCode.LAYOUT_NOT_FOUND:
                ...
                if (data.isStartPage === true) {
                    promise = _showClientMessage.call(this, logId, [data.layoutId, data.pageId]);
                }
                break;
            ...
            case LogCode.CONTENT_LOADING_IN_PROCESS:
                console.iatWarn('content loading in process!');
                if (data.contentId) {
                    args.push(data.contentId);
                } else if (data.pageId) {
            ...
            case LogCode.VISU_ACTIVATE_FAILED:
                ...
                promise = _showClientMessage.call(this, logId, [data.visuId, data.code], data.container);
                break;
        }
        return promise;
    };
    ...
    function _showClientMessage(logId, args, container) {
        ...
        if (this.settings.clientMessage === true) {
            return _message(messageKey, args).then(function (text) {
                if (container) {
    ...
    function _message(messageKey, args) {
        ...
        if (message !== undefined) {
            return brease.textFormatter.format(message, args);
        }
        return Promise.resolve();
    }
