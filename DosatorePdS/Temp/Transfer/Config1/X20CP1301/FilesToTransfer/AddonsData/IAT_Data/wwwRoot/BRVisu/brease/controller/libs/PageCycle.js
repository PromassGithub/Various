    ...
    function (EventDispatcher, BreaseEvent, ClientSystemEvent, contentManager) {
        ...
        function _finishCallback() {
            if (typeof this.callback === 'function') {
                ...
                // we need to delete this.callback before calling the function as otherwise we could produce an infinite loop when
                // inside the call e.g. a content is disposed and calls the contentDeactivatedListener in PageCycle
                this.callback = null;
