define([
    ...
    p.setAdditionalStyle = function (styleName) {
        SuperClass.prototype.setAdditionalStyle.apply(this, arguments);
        if (this.dropDownBoxView.listContainer !== undefined) {
            this.dropDownBoxView.listContainer.addClass(this._createStyleClass(styleName));
        }
        var action = DropDownBoxActions.additionalStyleChange(this.getAdditionalStyles());
        this.store.dispatch(action);
    };
    
    p.removeAdditionalStyle = function (styleName) {
        SuperClass.prototype.removeAdditionalStyle.apply(this, arguments);
        if (this.dropDownBoxView.listContainer !== undefined) {
            this.dropDownBoxView.listContainer.removeClass(this._createStyleClass(styleName));
        }
        var action = DropDownBoxActions.additionalStyleChange(this.getAdditionalStyles());
        this.store.dispatch(action);
    };
