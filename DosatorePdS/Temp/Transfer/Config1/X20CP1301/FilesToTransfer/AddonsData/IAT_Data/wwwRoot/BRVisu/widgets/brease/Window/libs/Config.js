define([
    ...
    */
    /**
    * @cfg {brease.enum.AutoRaise} autoRaise='enabled'
    * @iatStudioExposed
    * Can be used to configure the behavior of raising a window above others when the user 
    * clicks on it. The default behavior will raise the window automaically when the user clicks on it
    */
    /**
    * @cfg {String} windowType
    * type of the window, e.g. 'NumPad', 'KeyBoard', 'ChangePasswordDialog', 'GenericDialog', etc.  
    * defined in derived widgets of Window  
    * is used internally for handling of specific window behavior
    */
    /**
    * @cfg {Object} focusEvent
    * @cfg {String} focusEvent.start
    * name of event, which is used to start focus handling in brease.controller.FocusManager
    * @cfg {String} focusEvent.end
