...
export AS_PROJECT_PATH := C:/projects/GitH/Various/CAN_TEST/AVENTICS_TEST
export AS_PROJECT_NAME := AVENTICS_TEST
export AS_SYSTEM_PATH := C:/BrAutomation/AS/System
export AS_VC_PATH := C:/BrAutomation/AS49/AS/VC
export AS_TEMP_PATH := C:/projects/GitH/Various/CAN_TEST/AVENTICS_TEST/Temp
export AS_CONFIGURATION := AVENTICS
export AS_BINARIES_PATH := C:/projects/GitH/Various/CAN_TEST/AVENTICS_TEST/Binaries
...
export WIN32_AS_PROJECT_PATH := "C:\projects\GitH\Various\CAN_TEST\AVENTICS_TEST"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS49\AS\VC"
export WIN32_AS_TEMP_PATH := "C:\projects\GitH\Various\CAN_TEST\AVENTICS_TEST\Temp"
export WIN32_AS_BINARIES_PATH := "C:\projects\GitH\Various\CAN_TEST\AVENTICS_TEST\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/AVENTICS_TEST.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'   
